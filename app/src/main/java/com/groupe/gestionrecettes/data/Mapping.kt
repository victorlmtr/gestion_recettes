...
//            category = getTypeLabel(recette.idTypeRecette),    // Assume this function gets the type label
//            country = getCountryLabel(recette.idPays),        // Assume this function gets the country label
//            categoryIcon = getIconResource(recette.idTypeRecette),  // Assume this function gets the correct icon resource
